 ...
 * @returns {Promise<object>} - User's devices response with UserDevicesResponse schema.
 */
 ...
 * @returns {Promise<object>} - Filtered devices response with UserDevicesResponse schema.
 */
